...
<p align="center">
  ...
  <b>Figure 1. Workflow for the comparative analysis of de novo assembly tools [1].</b>
</p>
...
Ultimately, our results from the OLC approach were inconclusive, a possibility recognized early in the formulation of the project approach. Despite following Canu tutorials, we were unable to receive results due to the assembly tool. Notably, Canu, while acknowledging the high quality of short reads, deems them unsuitable due to their insufficient length for accurate alignment. The tool instead utilizes reads from other repeat instances for correction, leading to potential inaccuracies in the correction process [7]. While intriguing in its capacity to identify short reads despite specified input arguments, this limitation hindered our ability to compare Canu’s outputs with those generated by other assembly methods.

## References
1. Cherukuri, Y., & Janga, S. C. (2016). Benchmarking of de novo assembly algorithms for Nanopore data reveals optimal performance of OLC approaches. BMC genomics, 17 Suppl 7(Suppl 7), 507. https://doi.org/10.1186/s12864-016-2895-8
2. Cox, W. by: G. (2023, June 16). The de bruijn sequence. Baeldung on Computer Science. https://www.baeldung.com/cs/de-bruijn-sequence
3. De Novo Genome Assembly using velvet. Introduction to de novo assembly with Velvet - Bioinformatics Documentation. (n.d.). https://www.melbournebioinformatics.org.au/tutorials/tutorials/assembly/assembly-background/
4. Overlap Layout Consensus Assembly - Department of Computer Science. (n.d.-a). https://www.cs.jhu.edu/~langmea/resources/lecture_notes/assembly_olc.pdf
5. Warren, R. L., Sutton, G. G., Jones, S. J., & Holt, R. A. (2006). Assembling millions of short DNA sequences using SSAKE. Bioinformatics, 23(4), 500-501. https://doi.org/10.1093/bioinformatics/btl629
6. Canu. (n.d.). https://canu.readthedocs.io/en/latest/index.html
7. Canu FAQ. Canu FAQ - canu 2.2 documentation. (n.d.). https://canu.readthedocs.io/en/latest/faq.html#can-i-use-illumina-data-too
